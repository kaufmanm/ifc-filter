...
rem linreg ifc
rem java -Xmx1536m -cp ../.././build/classes;../.././lib/* weka.classifiers.meta.FilteredClassifierNormalized -t ../arff/anneal_class=2.arff -x 10 -F "weka.filters.supervised.attribute.IFC_Filter " -W weka.classifiers.functions.LinearRegression > ../output/test_anneal_linreg_ifc.txt

rem linreg nonifc
rem java -Xmx1536m -cp ../.././build/classes;../.././lib/* weka.classifiers.functions.LinearRegression -S 0 -R 1.0E-8 -t ../arff/anneal_class=2.arff -x 10 > ../output/test_anneal_linreg_nonifc.txt

rem gaussian ifc
rem rem java -Xmx1536m -cp ../.././build/classes;../.././lib/* weka.classifiers.meta.FilteredClassifierNormalized -t ../arff/anneal_class=2.arff -x 10 -F "weka.filters.supervised.attribute.IFC_Filter " -W weka.classifiers.functions.GaussianProcesses > ../output/test_anneal_gaussian_ifc.txt

rem gaussian nonifc
rem rem java -Xmx1536m -cp ../.././build/classes;../.././lib/* weka.classifiers.functions.GaussianProcesses -t ../arff/anneal_class=2.arff -x 10 > ../output/test_anneal_gaussian_nonifc.txt

rem m5p ifc
rem java -Xmx1536m -cp ../.././build/classes;../.././lib/* weka.classifiers.meta.FilteredClassifierNormalized -t ../arff/anneal_class=2.arff -x 10 -F "weka.filters.supervised.attribute.IFC_Filter " -W weka.classifiers.trees.M5P > ../output/test_anneal_m5p_ifc.txt

rem m5p nonifc
rem java -Xmx1536m -cp ../.././build/classes;../.././lib/* weka.classifiers.trees.M5P -t ../arff/anneal_class=2.arff -x 10 > ../output/test_anneal_m5p_nonifc.txt
...
rem logreg nonifc
rem java -Xmx1536m -cp ../.././build/classes;../.././lib/* weka.classifiers.functions.LogisticForIFC -t ../arff/anneal_class=2.arff -x 10 > ../output/test_anneal_logreg_nonifc.txt
