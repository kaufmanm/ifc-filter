 ...
 *    Changes Added by Dr. Michael Kaufmann (normalization of Output in [0,1]; 
 * adapted default classifier and filter)
 */
 ...
 */
public class FilteredClassifierNormalized 
  ...
  protected String defaultClassifierString() {
    ...
    return "weka.classifiers.functions.LogisticForIFC";
  }

  /**
   * Default constructor.
   */
  public FilteredClassifierNormalized() {

    m_Classifier = new weka.classifiers.functions.LogisticForIFC();
    m_Filter = new weka.filters.supervised.attribute.IFC_Filter();
  }
  ...
  public double [] distributionForInstance(Instance instance)
    ...
    */
    ...
    System.err.println("FilteredClassifier:: " 
                       ...
                       + " out: " + newInstance);
    */
    double[] d = m_Classifier.distributionForInstance(newInstance);
    double output = d[0];
    if (output<0) d[0] = 0;
    else if(output>1) d[0] = 1;
    return d;
  ...
  public static void main(String [] argv)  {
    runClassifier(new FilteredClassifierNormalized(), argv);
  }
}
