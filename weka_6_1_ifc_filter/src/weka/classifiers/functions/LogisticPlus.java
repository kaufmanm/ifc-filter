 ...
 */
public class LogisticPlus extends AbstractClassifier implements OptionHandler {
...
private Enumeration attributes;
  ...
  private void newtn(double[] x, int n, double[][] X, double[] Y ) 
	...
	g[i]=sum;
      ...
      //fjac.lubksb(fjac.ludcmp(),p);cedric
      //fjac.eigenvalueDecomposition(fjac.LUDecomposition(),p);
  ...
  public void buildClassifier(Instances train) throws Exception {
    ...
    System.out.println("Target variable: " + this.train1.attribute(m_ClassIndex).name());
